...
const listOfUnits = [
    {
        ...
        textStrenghts: `Среди улучшенных юнитов 1-го уровня: Самый высокий показатель здоровья (наряду с капитанами кентавров).
            Самый высокий показатель урона (наряду с капитанами кентавров и гноллами-мародёрами).
            Самый высокий показатель атаки (наряду с капитанами кентавров и скелетами-воинами).
            Второй по величине показатель защиты (выше только у скелетов-воинов и гноллов-мародёров).`,
...

    {
        ...
        titleStrenghts: "Сильные стороны",
        textStrenghts: `Среди улучшенных юнитов 2-го уровня:
        Дальнобойная атака.
        ...
        titleWeaknesses: "Слабые стороны",
        textWeaknesses: `Среди улучшенных юнитов 2-го уровня:
...

    {
        ...
        titleFeatures: "Особенности",
        textFeatures: `Большое существо – занимает две клетки на поле боя.
        Летающее существо.
        Бесконечный отпор – юнит отвечает на все атаки за ход.`,
        titleTactics: "Тактика",
        ...
        titleStrenghts: "Сильные стороны",
        textStrenghts: `Среди улучшенных юнитов 3-го уровня:
        Бесконечный отпор.
        Второй по величине показатель скорости (выше лишь у стрекоз).
        Высокий показатель урона (выше лишь у церберов и элементалей Льда).
        Самый высокий прирост (с учётом пристройки – Бастиона).`,
        titleWeaknesses: "Слабые стороны",
        textWeaknesses: `Среди улучшенных юнитов 3-го уровня:
        Нет.`,
...

    {
        ...
        titleStrenghts: "Сильные стороны",
        textStrenghts: `Среди улучшенных юнитов 4-го уровня:
        Сдвоенный удар, особенно если он получается удачным, т.е. наносящим двойной урон.
        Самый высокий показатель урона (даже без учёта сдвоенного удара).
        Самый высокий показатель защиты (наряду с великими василисками).`,
        titleWeaknesses: "Слабые стороны",
...

    {
        ...
        titleStrenghts: "Сильные стороны",
        textStrenghts: `Среди улучшенных юнитов 5-го уровня:
        Дальнобойная атака.
        Отсутствие штрафа в рукопашном бою.
        Низкая стоимость (ниже лишь у дендроидов-солдат).`,
        titleWeaknesses: "Слабые стороны",
        textWeaknesses: `Среди улучшенных юнитов 5-го уровня:
        Самый низкий показатель здоровья.
        Самый низкий показатель защиты (наряду с могучими личами).
        Низкий показатель урона (ниже лишь у элементалей Магмы).`,
...

    {
        ...
        titleStrenghts: "Сильные стороны",
        textStrenghts: `Среди улучшенных юнитов 6-го уровня:
            Второй по величине показатель защиты (выше лишь у зловещих рыцарей).
            Третий по величине показатель урона (выше лишь у королев наг и зловещих рыцарей).
            Кавалерийский бонус.`,
        titleWeaknesses: "Слабые стороны",
        textWeaknesses: `Среди улучшенных юнитов 6-го уровня:
            Высокая стоимость (выше лишь у королев наг и зловещих рыцарей).`,
